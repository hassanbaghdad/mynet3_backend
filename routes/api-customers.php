...
Route::middleware(['auth:sanctum','api','accountant_mid'])->post('delete-customer',[customers_controller::class,'delete_customer']);
Route::middleware(['auth:sanctum','api','accountant_mid'])->post('active-net',[customers_controller::class,'active_net']);
Route::middleware(['auth:sanctum','api'])->post('get-customer-debts',[customers_controller::class,'get_customer_debts']);
Route::middleware(['auth:sanctum','api','accountant_mid'])->post('add-debt',[customers_controller::class,'add_debt']);
